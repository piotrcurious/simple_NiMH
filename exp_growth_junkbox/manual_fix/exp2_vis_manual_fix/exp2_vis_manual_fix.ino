...
//            for (size_t j = 0; j < coeffs.size(); ++j) {
            ...
            // Adaptive learning rate
            double currentMSE = calculateMSE(coeffs, x, y);
            ...
            // Convergence check
            //Serial.println(abs(currentMSE - prevMSE));
            //if (abs(currentMSE - prevMSE) < CONVERGENCE_THRESHOLD) {
            //    break;
            //}
            //yield(); // otherwise WDT kicks in :D
        }
