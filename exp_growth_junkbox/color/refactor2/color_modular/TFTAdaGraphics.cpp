...
void TFTGraphics::drawPixel(int x, int y, int color) {
    tft.drawPixel(x, y, color ? ILI9341_WHITE : ILI9341_BLACK);
}
...
void TFTGraphics::display() {
    // No-op for TFT as updates are immediate
}
...
void TFTGraphics::visualizeGrowthAnalysis(
    ...
    tft.drawRect(plotX, plotY, plotWidth, plotHeight, ILI9341_WHITE);
